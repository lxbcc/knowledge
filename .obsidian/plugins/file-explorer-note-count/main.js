...
class FENoteCountSettingTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        new obsidian.Setting(containerEl)
            .setName('显示所有数字')
            .setDesc('如果您希望在展开折叠的文件夹后仍然看到笔记数量，请开启此选项。')
        ...
        new obsidian.Setting(containerEl)
            .setName('添加根文件夹')
            .setDesc('默认情况下，Obsidian 没有提供根文件夹。它被移动到下拉菜单中，以便在保险库之间切换。 ' +
            '如果希望在文件资源管理器中显示根文件夹及其计数，请启用此选项。')
    ...
    filterOpt() {
        new obsidian.Setting(this.containerEl)
            .setName('仅显示Markdown笔记')
            .setDesc('关闭此选项以选择应被计数的文件。')
        ...
        if (!this.showOnlyNoteValue) {
            new obsidian.Setting(this.containerEl)
                ...
                descEl.appendText('在计数过程中包含/排除文件的扩展名列表');
                ...
                text.setPlaceholder('保持空白以计算所有类型的文件。');
